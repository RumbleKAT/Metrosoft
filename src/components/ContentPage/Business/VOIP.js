...
const features = [
  {
    title: "안정성",
    content: [
      "인터넷 또는 전기가 끊겨도 안전합니다.",
      "인터넷에 문제가 있거나 전원에 문제가 생길 경우 자동으로 KT 유선전화로 전환 되어 안전합니다."
    ]
  },
  {
    title: "편리성",
    content: [
      "기존 전화번호 그대로 사용이 가능합니다.",
      "RID(전화번호 변경)서비스로 기존 전화번호와 전화기를 그대로 사용합니다."
    ]
  },
  {
    title: "품질",
    content: [
      "끊김이나 잡음이 발생하지 않습니다",
      "통화 품질을 최우선으로 하여 고가의 무압축 코덱 방식을 채택하여 통화품질을 최우선으로 보장합니다."
    ]
  },
  {
    title: "저렴한 가격",
    content: [
      "시외를 걸더라도 가격은 시내요금입니다.",
      "사내 외 구분 없이 가장 낮은 가격으로 통화를 하실 수 있습니다."
    ]
  },
  {
    title: "유연성",
